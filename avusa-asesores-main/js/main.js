...
import { setupPrivacyModal, setupServiceModal, setupLegalNoticeModal, setupDiscountPolicyModal } from './modules/modals.js';
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Setup discount policy modal
  setupDiscountPolicyModal();
});